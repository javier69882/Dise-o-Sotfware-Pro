...
class _CreateProfileScreenState extends State<CreateProfileScreen> {
  ...
  final List<String> _opcionesRol = [
    "Paciente", "Administrador", "Secretario", "Enfermero", "Médico"
  ];

  final List<String> _opcionesRiesgo = [
    "Adultos Mayores", "Crónicos", "Embarazadas", "Personal de Salud", "Jovenes Sanos", "Público General"
  ];
      ...
      switch (_rolSeleccionado) {
        case "Administrador":
          nuevoUsuario = Administrador(
            rut: _rutCtrl.text, nombres: _nombresCtrl.text, apellidos: _apellidosCtrl.text,
            correo: _correoCtrl.text, telefono: "S/N", fechaNacimiento: fechaNac,
        ...
        default:
          nuevoUsuario = Paciente(
            rut: _rutCtrl.text, nombres: _nombresCtrl.text, apellidos: _apellidosCtrl.text,
            correo: _correoCtrl.text, telefono: "S/N", fechaNacimiento: fechaNac,
            prevision: "Fonasa", grupoRiesgo: _grupoRiesgoSeleccionado, estadoVacunacion: "Sin vacunas",
          );
          break;
      }
        ...
        child: ConstrainedBox(
          ...
          child: Padding(
            ...
            child: Form(
              ...
              child: ListView(
                children: [
                  const Text("Datos de la Cuenta", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                  ...
                  const Text("Información Específica del Rol", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 16),
                  ...
                  if (_rolSeleccionado == "Administrador") ...[
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: "Departamento a Cargo", border: OutlineInputBorder()),
                    ),
                  ],
                  ...
                  if (_rolSeleccionado == "Secretario") ...[
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: "ID de Secretario (Ej: SEC-002)", border: OutlineInputBorder()),
                    ),
                  ],

                  if (_rolSeleccionado == "Enfermero" || _rolSeleccionado == "Médico") ...[
                    TextFormField(
                      controller: _registroCtrl,
                      decoration: const InputDecoration(labelText: "Registro Nacional de Salud", border: OutlineInputBorder()),
                    ),
                    const SizedBox(height: 16),
                  ],
                  ...
                  if (_rolSeleccionado == "Enfermero") ...[
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: "Unidad Asignada (Ej: Vacunatorio B)", border: OutlineInputBorder()),
                    ),
                  ],
                  ...
                  if (_rolSeleccionado == "Médico") ...[
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: "Especialidad (Ej: Inmunología)", border: OutlineInputBorder()),
                    ),
                  ],
                  ...
                  ElevatedButton(
                    ...
                    child: Text("Registrar $_rolSeleccionado", style: const TextStyle(fontSize: 16)),
                  ),
                  const SizedBox(height: 32),
                ],
              ),
