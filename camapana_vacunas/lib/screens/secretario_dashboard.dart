...
class _SecretarioDashboardState extends State<SecretarioDashboard> {
              ...
              content: SingleChildScrollView(
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(controller: rutCtrl, decoration: const InputDecoration(labelText: "RUT Paciente"), validator: (v) => v!.isEmpty ? "Obligatorio" : null),
                      TextFormField(controller: nombresCtrl, decoration: const InputDecoration(labelText: "Nombres"), validator: (v) => v!.isEmpty ? "Obligatorio" : null),
                      TextFormField(controller: apellidosCtrl, decoration: const InputDecoration(labelText: "Apellidos"), validator: (v) => v!.isEmpty ? "Obligatorio" : null),
                      TextFormField(controller: correoCtrl, decoration: const InputDecoration(labelText: "Correo Electrónico"), validator: (v) => v!.isEmpty ? "Obligatorio" : null),
                      const SizedBox(height: 16),
                      DropdownButtonFormField<String>(
                        value: grupoRiesgo,
                        decoration: const InputDecoration(labelText: "Grupo de Riesgo", border: OutlineInputBorder()),
                  ...
                  onPressed: () {
                    if (formKey.currentState!.validate()) {
                      var nuevoPaciente = Paciente(
                        rut: rutCtrl.text, nombres: nombresCtrl.text, apellidos: apellidosCtrl.text,
                        correo: correoCtrl.text, telefono: "S/N", fechaNacimiento: DateTime(1990, 1, 1),
                        rutSecretarioCreador: db.usuarioActivo!.rut,
                        prevision: "Fonasa", grupoRiesgo: grupoRiesgo, estadoVacunacion: "Sin vacunas"
                      );
                      setState(() {
                      ...
                      CustomDialogs.showSnackBar(context, "Paciente registrado e integrado al selector.");
                    }
                  },
  ...
  Widget build(BuildContext context) {
    ...
    for (var c in db.centros) { todasLasCitas.addAll(c.citasAgendadas); }
    ...
    return Scaffold(
      backgroundColor: Colors.transparent, // Permite ver el fondo global si existe
      body: Column(
        children: [
          // ENCABEZADO
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                // Botón de Registrar Paciente movido al encabezado
                ElevatedButton.icon(
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Módulo de Agendamiento", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onBackground)), // <--- DINÁMICO
                  ...
                  DropdownButtonFormField<Campana>(
                    ...
                    decoration: InputDecoration(labelText: "Campaña Activa", prefixIcon: Icon(Icons.campaign_outlined, color: Theme.of(context).colorScheme.primary)), // <--- DINÁMICO
                  ...
                  if (_campanaSeleccionada!.tramos.isNotEmpty) ...[
                    DropdownButtonFormField<TramoCampana>(
                      ...
                      decoration: InputDecoration(labelText: "Tramo de Prioridad", prefixIcon: Icon(Icons.people_outline, color: Theme.of(context).colorScheme.primary)), // <--- DINÁMICO
                  ...
                  DropdownButtonFormField<CentroVacunacion>(
                    ...
                    decoration: InputDecoration(labelText: "Sede de Vacunación", prefixIcon: Icon(Icons.local_hospital_outlined, color: Theme.of(context).colorScheme.primary)), // <--- DINÁMICO
                    ...
                    children: [
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Theme.of(context).colorScheme.surface,
                              borderRadius: BorderRadius.circular(15),
                              border: Border.all(color: Theme.of(context).colorScheme.outlineVariant, width: 1.5), // <--- DINÁMICO (Asegúrate de agregar outlineVariant a tu tema si no lo tienes, o usa onSurfaceVariant.withOpacity(0.2))
                            ),
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(fontSize: 16, color: _fechaSeleccionada == null ? Theme.of(context).colorScheme.onSurfaceVariant : Theme.of(context).colorScheme.onBackground), // <--- DINÁMICO
                                ),
                              ],
                            ),
                          ),
                      ...
                      Expanded(
                        ...
                        child: DropdownButtonFormField<TimeOfDay>(
                          ...
                          decoration: InputDecoration(labelText: "Bloque", prefixIcon: Icon(Icons.access_time_rounded, color: Theme.of(context).colorScheme.primary)), // <--- DINÁMICO
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: (_tramoSeleccionado == null || _centroSeleccionado == null || _fechaSeleccionada == null || _horaSeleccionada == null) ? null : () {
                      ...
                      if (_rutBeneficiarioSeleccionado == db.usuarioActivo!.rut) {
                        pacienteDestino = Paciente(rut: db.usuarioActivo!.rut, nombres: db.usuarioActivo!.nombres, apellidos: db.usuarioActivo!.apellidos, correo: db.usuarioActivo!.correo, telefono: "S/N", fechaNacimiento: DateTime.now(), prevision: "Fonasa", grupoRiesgo: "Público General", estadoVacunacion: "Sin vacunas");
                      } else {
                  ...
                  Row(
                    children: [
                      ...
                      Text("Historial de Citas", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onBackground)), // <--- DINÁMICO
                    ],
                  ),
                  const SizedBox(height: 16),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: Colors.black.withOpacity(0.03), // Sombras sutiles sí pueden ser black con opacidad
                              blurRadius: 10,
                        ...
                        child: ListTile(
                          ...
                          leading: Container(
                            ...
                            decoration: BoxDecoration(color: Theme.of(context).colorScheme.primaryContainer, shape: BoxShape.circle), // <--- DINÁMICO
                            child: Icon(Icons.vaccines_rounded, color: Theme.of(context).colorScheme.primary), // <--- DINÁMICO
                          ),
                          title: Text("RUT: ${c.rutPaciente}", style: const TextStyle(fontWeight: FontWeight.bold)),
                          subtitle: Padding(
                            padding: const EdgeInsets.only(top: 4.0),
                            child: Text("$centroNombre\n${DateFormatter.formatDateTime(c.fechaHora)}", style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant, height: 1.4)), // <--- DINÁMICO
                          ),
                          trailing: Container(
                            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                            decoration: BoxDecoration(
                              // Aquí podrías crear un color semántico específico para "éxito/confirmado" en tu AppTheme, 
                              // pero como solución intermedia usamos el secondaryContainer si el verde rompe tu paleta.
                              color: Theme.of(context).colorScheme.secondaryContainer, // <--- DINÁMICO
                              borderRadius: BorderRadius.circular(20),
                            ),
                            child: Text(c.estado, style: TextStyle(color: Theme.of(context).colorScheme.onSecondaryContainer, fontWeight: FontWeight.w600, fontSize: 12)), // <--- DINÁMICO
                          ),
                        ),
                      );
                    },
