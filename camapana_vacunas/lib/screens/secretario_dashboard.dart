      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text("Módulo de Agendamiento Presencial", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              ElevatedButton.icon(
                onPressed: _mostrarFormularioCrearPaciente,
                icon: const Icon(Icons.person_add_alt_1),
                label: const Text("Registrar Paciente"),
                style: ElevatedButton.styleFrom(backgroundColor: Colors.amber.shade100, foregroundColor: Colors.black),
              )
            ],
          ),
          const SizedBox(height: 16),
          ...
          DropdownButtonFormField<String>(
            ...
            decoration: const InputDecoration(labelText: "Beneficiario de la Hora Médica", border: OutlineInputBorder(), filled: true, fillColor: Color(0xFFFFF9C4)),
            items: [
              DropdownMenuItem(value: db.usuarioActivo!.rut, child: Text("✨ Agendar para mí mismo (${db.usuarioActivo!.nombres})")),
              ...listaPacientes.map((p) => DropdownMenuItem(value: p.rut, child: Text("Paciente: ${p.nombres} ${p.apellidos} (${p.rut})")))
            ],
          ...
          if (_campanaSeleccionada!.tramos.isNotEmpty)
            DropdownButtonFormField<TramoCampana>(
              ...
              decoration: const InputDecoration(labelText: "Tramo de Prioridad", border: OutlineInputBorder()),
          ...
          DropdownButtonFormField<CentroVacunacion>(
            ...
            decoration: const InputDecoration(labelText: "Sede de Vacunación", border: OutlineInputBorder()),
            ...
            children: [
              ...
              Expanded(
                ...
                child: DropdownButtonFormField<TimeOfDay>(
                  ...
                  decoration: const InputDecoration(labelText: "Bloque Horario", border: OutlineInputBorder()),
          ...
          ElevatedButton.icon(
            ...
            label: const Text("Confirmar Registro de Cita", style: TextStyle(fontSize: 16)),
          ...
          const Divider(),
          const Text("Control e Historial de Citas del Sistema:", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
